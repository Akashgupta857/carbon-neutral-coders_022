  ...
  return (
    <>
     ...
     <div ref={resumeRef}> 
      ...
      <div className="container2" style={{ backgroundColor: bgColor }}>
        <div className="photo" style={{textAlign:"centre"}}>
        <PhotoComp />
        <NameCompo />
        </div>
      ...
      {isLeftFirst ? (<>
          <div className="left2" style={{ backgroundColor: leftColor }}>
        ...
        <div className="right2" style={{ backgroundColor: rightColor }}>
